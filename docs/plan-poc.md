...
| 0.6 | Images de prod (`Dockerfile.prod`) + entrypoint unattended (migrate → `init:user` → callback statut) | 1.5–2 j | 🟡 images prod réparées + product packagé (0.6a) ; entrypoint provisioning à faire (0.6b) |
