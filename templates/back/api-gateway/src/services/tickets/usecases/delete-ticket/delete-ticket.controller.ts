...
export class DeleteTicketController {
  ...
  @Delete(routesConfig.ticket.deleteTicket.path)
  @UseGuards(JwtAuthGuard, RolesGuard)
  @Roles('tickets')
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Supprimer un ticket' })
  async delete(@Param('id') id: string) {
    const url = routesConfig.ticket.deleteTicket.link(this.services.ticket, id);
    return this.httpProxy.delete(url, 'Delete ticket failed');
  }
}
