...
export class DeleteProductController {
  ...
  @Delete(routesConfig.product.deleteProduct.path)
  @UseGuards(JwtAuthGuard, RolesGuard)
  @Roles('products')
  @ApiOperation({ summary: "Suppression d'un produit" })
  async delete(@Param('id') id: string) {
    const url = routesConfig.product.deleteProduct.link(this.services.product, id);
    return this.httpProxy.delete(url, 'Delete product failed');
  }
}
